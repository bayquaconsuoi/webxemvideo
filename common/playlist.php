  ...
  <div class="container">
    ...
    <div class="main_container">
      <div class="main_container-inner">
          <?php
              if (!empty($_SESSION['disliked_success'])) {
                $disliked_success = $_SESSION['disliked_success'];
              }
              if (isset($_SESSION['disliked_success'])) {
                $dislike_success_notify = <<< EOD
                  <div class="alert">
                    $disliked_success
                  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
                  </div>
                EOD;
                echo $dislike_success_notify;
                unset($_SESSION['disliked_success']);
              }
